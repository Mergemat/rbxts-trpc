...
export type TRPCErrorCode = "BAD_REQUEST" | "UNAUTHORIZED" | "FORBIDDEN" | "NOT_FOUND" | "CONFLICT" | "INTERNAL_SERVER_ERROR";
...
export type ProcedureResolver<TContext, TInput, TOutput> = (options: ProcedureResolverOptions<TContext, TInput>) => MaybePromise<TOutput>;
...
export type ProcedureMiddleware<TContext, TInput, TOutput> = (options: ProcedureMiddlewareOptions<TContext, TInput, TOutput>) => MaybePromise<TOutput>;
...
export type EventMiddleware<TContext, TInput> = (options: EventMiddlewareOptions<TContext, TInput>) => MaybePromise<void>;
...
export type AnyNode<TContext> = Procedure<TContext, any, any, ProcedureIntent> | ServerEvent<TContext, any> | ClientEvent<TContext, any> | Router<TContext, RouterShape<TContext>>;
